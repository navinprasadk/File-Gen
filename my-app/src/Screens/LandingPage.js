...
export default class LandingPage extends Component {
        ...
        context.setState({
          ...
          savedData:
            res.data.pipeline.environment != undefined
              ...
              : {},
          agentName:
            res.data.pipeline.agent != undefined
              ? res.data.pipeline.agent.name
              : ""
        });
      })
      .catch(err => {
  ...
  handleSave = () => {
    ...
    if (Object.keys(entireJSON).length) {
      ...
      entireJSON.pipeline["agent"]["name"] = this.state.agentName.length
    ...
    return (
      <React.Fragment>
        ...
        <Form
          ...
          style={{ marginLeft: "25%", width: "50%", marginTop: "4%" }}
        >
          <Form.Field>
