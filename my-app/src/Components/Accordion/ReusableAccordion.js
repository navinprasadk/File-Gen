...
import { Accordion, Icon, Segment, Button, Grid, Label } from 'semantic-ui-react'
    ...
    return (
      <Accordion>
        {data.map((item, key) => {
         return (
           <>
              <Accordion.Title  className='Accordion_title'active={activeIndex === key} index={key} onClick={this.handleClick}>
                <Icon name='dropdown' />
                {item.name}
              </Accordion.Title>
